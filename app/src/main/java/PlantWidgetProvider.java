...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    private static RemoteViews getSinglePlantRemoteView(Context context, int imgRes, long plantId, boolean showWater) {
        ...
        wateringIntent.setAction(com.example.android.mygarden.PlantWateringService.ACTION_WATER_PLANT);
        // Add the plant ID as extra to water only that plant when clicked
        wateringIntent.putExtra(com.example.android.mygarden.PlantWateringService.EXTRA_PLANT_ID, plantId);
    ...
    private static RemoteViews getGardenGridRemoteView(Context context) {
        ...
        Intent intent = new Intent(context, com.example.android.mygarden.GridWidgetService.class);
